...
**Before any work in this repo, load the `pulseed` skill** (`.claude/skills/pulseed/SKILL.md`).
...
- The SDK imports only `@pulseed/event-schema/constants`, `/types` and `@pulseed/shared`, never the Zod root.
